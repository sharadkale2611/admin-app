...
const feesSlice = createSlice({
  ...
  reducers: {
    ...
    setFirmIdFilter: (state, action: PayloadAction<number | undefined>) => {
      state.filters.firmId = action.payload;
    },

    clearFilters: (state) => {
    state.filters.courseId = undefined;
    state.filters.firmId = undefined; 
},
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchCourseFees.fulfilled,
        (state, action: PayloadAction<CourseFee[]>) => {
          state.loading = false;
      ...
      .addCase(fetchCourseFees.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.payload as string) || "Failed to fetch course fees";
      })
      ...
      .addCase(fetchCourseFeeById.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.payload as string) || "Failed to fetch course fee details";
        state.currentCourseFee = null;
      })
      // Create Course Fee
      ...
      .addCase(createCourseFee.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.payload as string) || "Failed to create course fee";
      })
      // Update Course Fee
      ...
      .addCase(
        ...
        (state, action: PayloadAction<CourseFee>) => {
          ...
          if (
            state.currentCourseFee &&
            state.currentCourseFee.courseFeeId === action.payload.courseFeeId
          ) {
            state.currentCourseFee = action.payload;
          }
        }
      ...
      .addCase(updateCourseFee.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.payload as string) || "Failed to update course fee";
      })
      // Delete Course Fee
      ...
      .addCase(
        ...
        (state, action: PayloadAction<number>) => {
          ...
          if (
            state.currentCourseFee &&
            state.currentCourseFee.courseFeeId === action.payload
          ) {
            state.currentCourseFee = null;
          }
        }
      ...
      .addCase(deleteCourseFee.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.payload as string) || "Failed to delete course fee";
      });
  },
});
