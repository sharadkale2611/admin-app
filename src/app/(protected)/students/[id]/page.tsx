...
import { ArrowBack, Edit, Email, Phone, Person, Cake, School, Event, Code } from '@mui/icons-material';
import { useStudentDetailsViewModel } from '@/lib/features/student/useStudentDetailsViewModel';

export default function StudentDetails() {
    const { id } = useParams();
    const { student, isLoading, error } = useStudentDetailsViewModel(id as string);
                    ...
                    <Paper sx={{ p: 3, textAlign: 'center' }} elevation={2}>
                        ...
                        <Stack spacing={1} alignItems="flex-start">
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                ...
                                <Typography variant="body2">{student.email || 'No email'}</Typography>
                            </Box>

                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                <Phone fontSize="small" color="action" />
                                <Typography variant="body2">{student.mobileNumber || 'No phone'}</Typography>
                            </Box>
                        ...
                        <CardContent>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid size={{ xs: 12, sm: 6 }}>
                                    ...
                                    <Typography variant="body1">
                                        {student.gender === 'M' ? 'Male' : student.gender === 'F' ? 'Female' : student.gender || 'Not specified'}
                                    </Typography>
                                </Grid>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid size={{ xs: 12, sm: 6 }}>
                                    ...
                                    <Typography variant="body2">
                                        {student.updatedAt ? formatDate(student.updatedAt) : 'Never'}
                                    </Typography>
                                </Grid>
                            </Grid>
                        </CardContent>
