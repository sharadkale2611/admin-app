...
import useCreateQuestionTypeRuleViewModel from "@/lib/features/questionTypeRule/useCreateQuestionTypeRuleViewModel";
...
export default function CreateQuestionTypeRulePage() {
  const {
    formData,
    isSubmitting,
    error,
    ...
    handleSelectChange,
    handleSubmit,
  } = useCreateQuestionTypeRuleViewModel();
        ...
        <form
          onSubmit={async (e) => {
            ...
            if (result?.success) {
              ...
              setTimeout(() => {
                window.location.href = "/questionTypeRules";
              }, 1500);
            }
          }}
        >
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12 }}>
              <FormControl fullWidth size="small" required>
                ...
                <Select
                  ...
                  disabled={isSubmitting || isLoadingQuestionTypes}
                >
            ...
            <Grid size={{ xs: 12 }} sx={{ mt: 2 }}>
              <Box sx={{ display: "flex", gap: 2 }}>
                <Link href="/questionTypeRules" passHref>
                  <Button
                    variant="outlined"
                    color="secondary"
                    startIcon={<Cancel />}
