...
export default function CourseEdit() {
  ...
  const { categories, isLoading: categoriesLoading } = useCourseCategoryViewModel();
              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  >
                    ...
                    <Select
                      ...
                      value={formData.courseCategoryId || ""}
                      onChange={(e) =>
                        handleInputChange("courseCategoryId", Number(e.target.value))
                      }
                    >
                      {categories?.map((cat) => (
                        <MenuItem
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <FormControl fullWidth disabled={isSubmitting}>
                    ...
                    >
                      <MenuItem value={CourseLevel.Beginner}>
                        Beginner
                      </MenuItem>
          ...
          <Paper sx={{ p: 3 }} elevation={2}>
            ...
            <Grid container spacing={2}>
              <Grid size={{ xs: 6 }}>
                ...
                <Typography variant="body2">{course.courseId}</Typography>
              </Grid>
              <Grid size={{ xs: 6 }}>
                <Typography variant="subtitle2" color="text.secondary">
                  Created
              ...
              {course.firmName && (
                <Grid size={{ xs: 12 }}>
                  ...
                  <Typography variant="body2">{course.firmName}</Typography>
                </Grid>
              )}
            </Grid>
          </Paper>
