...
import useEditQuestionTypeViewModel from "@/lib/features/questionType/useEditQuestionTypeViewModel";
      ...
      <Paper elevation={0} sx={{ p: 3, border: "1px solid #e0e0e0" }}>
        ...
        >
          <Grid container spacing={2}>
            ...
            {/* Code (Read-only if system defined) */}
            <Grid size={{ xs: 12 }}>
              <TextField
                fullWidth
                label="Code"
